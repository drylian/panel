...
import { Configuration } from "@/controllers/config/Configuration";
import type { ConfigurationValue, ConfigurationKeys, AllConfigurations } from "./types";
...
export class Config {
    ...
    public static get<Key extends ConfigurationKeys>(
        ...
        if (!global.__Configurations) return undefined as unknown as ConfigurationValue<Key>;
